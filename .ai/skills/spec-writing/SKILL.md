---
name: spec-writing
description: Guide for creating high-quality specifications for hackathon-starter. Use when starting a new SPEC or reviewing specs against architectural standards.
---
