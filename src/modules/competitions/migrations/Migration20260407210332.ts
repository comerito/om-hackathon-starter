...
export class Migration20260407210332 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table "competitions_participant_profile" add column "discord_nick" varchar(255) null;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "bounties_activity_log" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "type" text not null, "pull_request_id" uuid null, "actor_user_id" uuid null, "message" text not null, "metadata" jsonb null, "created_at" timestamptz(6) not null, constraint "bounties_activity_log_pkey" primary key ("id"));`);
    this.addSql(`create index "bounties_activity_log_created_at_index" on "bounties_activity_log" ("created_at");`);
    this.addSql(`create index "bounties_activity_log_organization_id_index" on "bounties_activity_log" ("organization_id");`);
    this.addSql(`create index "bounties_activity_log_pull_request_id_index" on "bounties_activity_log" ("pull_request_id");`);
    this.addSql(`create index "bounties_activity_log_tenant_id_index" on "bounties_activity_log" ("tenant_id");`);

    this.addSql(`create table "bounties_pull_request" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "competition_id" uuid not null, "github_pr_id" int4 not null, "github_pr_number" int4 not null, "github_pr_url" text not null, "title" text not null, "description" text null, "diff_content" text null, "github_author" varchar(255) not null, "participant_id" uuid null, "team_id" uuid null, "status" text not null default 'detected', "classifications" jsonb null, "classification_confidence" float4 null, "classification_summary" text null, "total_points" int4 not null default 0, "points_override" jsonb null, "is_duplicate" bool not null default false, "duplicate_of_id" uuid null, "duplicate_marked_by" varchar(50) null, "duplicate_similarity" float4 null, "github_created_at" timestamptz(6) not null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "bounties_pull_request_pkey" primary key ("id"));`);
    this.addSql(`create index "bounties_pull_request_competition_id_index" on "bounties_pull_request" ("competition_id");`);
    this.addSql(`alter table "bounties_pull_request" add constraint "bounties_pull_request_github_pr_id_tenant_id_unique" unique ("github_pr_id", "tenant_id");`);
    this.addSql(`create index "bounties_pull_request_organization_id_index" on "bounties_pull_request" ("organization_id");`);
    this.addSql(`create index "bounties_pull_request_participant_id_index" on "bounties_pull_request" ("participant_id");`);
    this.addSql(`create index "bounties_pull_request_status_index" on "bounties_pull_request" ("status");`);
    this.addSql(`create index "bounties_pull_request_team_id_index" on "bounties_pull_request" ("team_id");`);
    this.addSql(`create index "bounties_pull_request_tenant_id_index" on "bounties_pull_request" ("tenant_id");`);
    ...
    this.addSql(`create table "mikro_orm_migrations_bounties" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);
    ...
    this.addSql(`alter table "competitions_participant_profile" drop column "discord_nick";`);
  }
