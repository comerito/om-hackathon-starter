...
export class Migration20260324210932 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table "competitions_announcement" alter column "updated_at" drop default;`);
    this.addSql(`alter table "competitions_announcement" alter column "updated_at" type timestamptz using ("updated_at"::timestamptz);`);

    this.addSql(`alter table "competitions_participation" drop constraint "competitions_participation_competition_id_customer_user_id_uniq";`);
    ...
    this.addSql(`alter table "competitions_participant_profile" drop constraint "competitions_participant_profile_customer_user_id_tenant_id_uni";`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "competitions_announcement" alter column "updated_at" type timestamptz(6) using ("updated_at"::timestamptz(6));`);
    this.addSql(`alter table "competitions_announcement" alter column "updated_at" set default now();`);

    this.addSql(`alter table "competitions_participant_profile" drop constraint "competitions_participant_profile_customer_user_id_2d5cb_unique";`);
    ...
    this.addSql(`alter table "competitions_participation" drop constraint "competitions_participation_competition_id_custome_2a558_unique";`);
