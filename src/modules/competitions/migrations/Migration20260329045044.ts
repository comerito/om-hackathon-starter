...
export class Migration20260329045044 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table "competitions_competition" add column "max_tracks_per_team" int not null default 1;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "competitions_competition" drop column "max_tracks_per_team";`);
  }
