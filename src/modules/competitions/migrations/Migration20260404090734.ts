...
export class Migration20260404090734 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table "competitions_participation" add column "github_username" varchar(255) null;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "competitions_participation" drop column "github_username";`);
  }
