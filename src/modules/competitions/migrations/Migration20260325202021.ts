...
export class Migration20260325202021 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table "competitions_agenda_item" add column "speaker_photo_url" varchar(1000) null;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "competitions_agenda_item" drop column "speaker_photo_url";`);
  }
