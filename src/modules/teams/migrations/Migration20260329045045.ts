...
export class Migration20260329045045 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table "teams_team_track" ("id" uuid not null default gen_random_uuid(), "team_id" uuid not null, "track_id" uuid not null, "competition_id" uuid not null, "tenant_id" uuid not null, "organization_id" uuid not null, "created_at" timestamptz not null, constraint "teams_team_track_pkey" primary key ("id"));`);
    ...
    // Data migration: populate junction table from existing Team.trackId
    this.addSql(`INSERT INTO "teams_team_track" ("id", "team_id", "track_id", "competition_id", "tenant_id", "organization_id", "created_at")
      SELECT gen_random_uuid(), t.id, t.track_id, t.competition_id, t.tenant_id, t.organization_id, NOW()
      FROM "teams_team" t
      WHERE t.track_id IS NOT NULL AND t.deleted_at IS NULL
      ON CONFLICT ("team_id", "track_id") DO NOTHING;`);
  }
