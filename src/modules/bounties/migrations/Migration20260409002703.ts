...
export class Migration20260409002703 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table "bounties_pull_request" add column "split_group_id" uuid null, add column "is_split_child" boolean not null default false;`);
    this.addSql(`create index "bounties_pull_request_split_group_id_index" on "bounties_pull_request" ("split_group_id");`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`drop index "bounties_pull_request_split_group_id_index";`);
    this.addSql(`alter table "bounties_pull_request" drop column "split_group_id", drop column "is_split_child";`);
  }
