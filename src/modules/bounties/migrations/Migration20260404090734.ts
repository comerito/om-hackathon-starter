...
export class Migration20260404090734 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "bounties_pull_request" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "competition_id" uuid not null, "github_pr_id" int not null, "github_pr_number" int not null, "github_pr_url" text not null, "title" text not null, "description" text null, "diff_content" text null, "github_author" varchar(255) not null, "participant_id" uuid null, "team_id" uuid null, "status" text not null default 'detected', "classifications" jsonb null, "classification_confidence" real null, "classification_summary" text null, "total_points" int not null default 0, "points_override" jsonb null, "is_duplicate" boolean not null default false, "duplicate_of_id" uuid null, "duplicate_marked_by" varchar(50) null, "duplicate_similarity" real null, "github_created_at" timestamptz not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "bounties_pull_request_pkey" primary key ("id"));`);
