...
export async function PATCH(request: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    console.error('[bounties/portal/judge/reject] PATCH error:', error)
...
export const openApi: OpenApiRouteDoc = {
  tag: 'Bounties Portal',
  summary: 'Reject bounty PR (portal judge)',
  methods: { PATCH: { summary: 'Reject a bounty PR as a portal judge' } },
}
