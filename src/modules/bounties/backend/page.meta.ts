...
const bountyIcon = React.createElement(
  'svg',
...
export const metadata = {
  ...
  pageTitle: 'Bounty Hunting',
  pageTitleKey: 'bounties.judge.title',
  pageGroup: 'HackOn',
  pageGroupKey: 'competitions.nav.group',
  pageOrder: 8,
  icon: bountyIcon,
  breadcrumb: [{ label: 'Bounty Hunting', labelKey: 'bounties.judge.title' }],
}
