...
export class Migration20260329045045 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table "projects_project" drop constraint "projects_project_team_id_competition_id_unique";`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "projects_project" drop constraint "projects_project_team_id_track_id_competition_id_unique";`);
