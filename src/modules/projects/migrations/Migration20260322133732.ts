...
export class Migration20260322133732 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "projects_project" ("id" uuid not null default gen_random_uuid(), "team_id" uuid not null, "competition_id" uuid not null, "track_id" uuid not null, "title" varchar(255) not null, "tagline" varchar(140) null, "description" text null, "problem_statement" text null, "solution" text null, "tech_stack" jsonb not null default '[]', "demo_url" varchar(1000) null, "repo_url" varchar(1000) null, "video_url" varchar(1000) null, "presentation_url" varchar(1000) null, "screenshot_ids" jsonb not null default '[]', "attachment_ids" jsonb not null default '[]', "uses_preexisting_code" boolean not null default false, "preexisting_code_description" text null, "built_during_hackathon_description" text null, "flagged_for_reuse" boolean not null default false, "flagged_by" uuid null, "flagged_at" timestamptz null, "flagged_reason" text null, "status" text not null default 'draft', "submitted_at" timestamptz null, "final_score" real null, "peer_vote_count" int null, "rank" int null, "manual_rank_override" int null, "tenant_id" uuid not null, "organization_id" uuid not null, "is_active" boolean not null default true, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "projects_project_pkey" primary key ("id"));`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "competitions_participant_profile" add constraint "competitions_participant_profile_customer_user_id_tenant_id_uni" unique ("customer_user_id", "tenant_id");`);
    ...
    this.addSql(`alter table "competitions_participation" add constraint "competitions_participation_competition_id_customer_user_id_uniq" unique ("competition_id", "customer_user_id");`);
    ...
    this.addSql(`create table "teams_team_member" ("id" uuid not null default gen_random_uuid(), "team_id" uuid not null, "customer_user_id" uuid not null, "competition_id" uuid not null, "role" text not null default 'member', "joined_at" timestamptz(6) not null, "left_at" timestamptz(6) null, "tenant_id" uuid not null, "organization_id" uuid not null, "deleted_at" timestamptz(6) null, constraint "teams_team_member_pkey" primary key ("id"));`);
