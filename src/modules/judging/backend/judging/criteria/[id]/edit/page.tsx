...
export default function EditCriterionPage({ params }: { params?: { id?: string } }) {
  ...
  const fields = React.useMemo<CrudField[]>(() => [
    ...
    {
      id: 'max_score',
      label: t('judging.fields.maxScore', 'Points (judges rate 1–10 stars)'),
      description: t('judging.fields.maxScoreHelp', "Judges always rate each criterion with 1–10 stars; the stars are converted to this criterion's points and weighted. Changing criteria while voting is open recomputes judges' scores, and changing the points reinterprets votes cast before star voting."),
      type: 'number',
      defaultValue: 10,
    },
    {
      id: 'weight',
      label: t('judging.fields.weight', 'Weight (0-1)'),
      description: t('judging.fields.weightHelp', "Weights are normalised, so they don't have to add up to 1 — but keeping their sum at 1 is recommended."),
      type: 'number',
      defaultValue: 0.25,
      placeholder: '0.25 = 25%',
    },
