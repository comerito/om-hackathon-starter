...
export class Migration20260324210934 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table "tracks_track" add column "short_description" text null, add column "attachment_ids" jsonb not null default '[]';`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "tracks_track" drop column "short_description", drop column "attachment_ids";`);
